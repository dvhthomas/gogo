...
func extractCSRFToken(t *testing.T, body []byte) string {
	// FindSubmatch returns an array with the entire matched patter in the first
	...
	// the 'html/template' library escapes all dynamic data, so we need
	// to reverse that to get the original CSRF string
